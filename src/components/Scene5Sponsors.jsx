...
/**
 * Scene5Sponsors - Sponsors section with animated logo grid
 * Features hover effects and smooth entrance animations
 */
  ...
  return (
    ...
    >
      ...
      <div className="sponsors-title" style={{ textAlign: 'center', marginBottom: '5rem', opacity: 0 }}>
        ...
        >
          <span style={{ color: '#f8fafc' }}>Backed by the</span>{' '}
      ...
      >
        {sponsors.map((sponsor, i) => (
          <div
            ...
            style={{ opacity: 0, flexDirection: 'column', gap: '0.5rem' }}
          >
            {/* Sponsor icon */}
      ...
      >
        ...
        <a
          ...
          onMouseOver={(e) => {
            e.target.style.background = 'rgba(201, 168, 124, 0.1)'
            e.target.style.boxShadow = '0 0 25px rgba(201, 168, 124, 0.25)'
          }}
          onMouseOut={(e) => {
