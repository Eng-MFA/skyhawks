...
/**
 * Scene2Engineering - Fixed Wing UAV engineering breakdown section
 * Shows technical specs with animated spec panels
 * UAV disassembly is controlled by parent via scroll progress
 */
...
export default function Scene2Engineering({ onHighlight }) {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // Animate each spec card on scroll
    ...
    >
      ...
      <div className="section-heading" style={{ textAlign: 'center', marginBottom: '5rem', opacity: 0 }}>
        ...
        >
          ...
          <span className="gradient-text-gold">Dominate</span>
        </h2>
        ...
        >
          Every component is precision-engineered for maximum performance.
          Scroll to explore each part of our fixed-wing UAV.
        </p>
      </div>
            ...
            >
              {spec.details.map((detail) => (
                <div key={detail.label}>
                  <div className="spec-value" style={{ fontSize: '1.1rem' }}>
                    {detail.value}
                  </div>
            ...
            <div
              style={{
                ...
                background: `linear-gradient(90deg, transparent, ${
                  spec.part === 'motors' || spec.part === 'battery' ? '#D4A843' : '#C9A87C'
                }, transparent)`,
                opacity: 0.5,
              }}
            />
      ...
      >
        {[
          ...
          >
            ...
            <div className="spec-label" style={{ marginTop: '0.5rem' }}>
              {stat.label}
            </div>
          </div>
        ))}
